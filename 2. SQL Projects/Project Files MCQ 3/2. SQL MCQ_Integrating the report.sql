...
-- Checking for incorrect records (Where scores from auditors differ from scores of employees)
SELECT
	auditor_report.location_id AS audit_location,
	visits.record_id,
	auditor_report.true_water_source_score AS auditor_score,
...
-- Checking if employee also made errors in the type_of_water_source column
SELECT
auditor_report.location_id AS audit_location,
