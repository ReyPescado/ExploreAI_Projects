...
-- Using RANK() to identify most used water sources that need to be fixed first
SELECT
	source_id,
    type_of_water_source,
...
-- Using DENSE_RANK() to identify most used water sources that need to be fixed first
SELECT
	source_id,
    type_of_water_source,
	number_of_people_served,
...
-- Using ROW_NUMBER() to identify most used water sources that need to be fixed first
SELECT
	source_id,
    type_of_water_source,
	number_of_people_served,
