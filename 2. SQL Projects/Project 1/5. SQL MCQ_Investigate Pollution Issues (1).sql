...
-- Updating Results in Description column of well_pollution table (Ecoli)
UPDATE 
	well_pollution
SET
...
-- Updating Results in Description column of well_pollution table (Giardia)
UPDATE 
	well_pollution
SET
...
-- Updating Results Column from Clean to Contaminted in well_pollution table
UPDATE 
	well_pollution
SET 
...
-- Checking if Updates have taken effect 
SELECT
*
FROM
	well_pollution
